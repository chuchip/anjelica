...
select 	usu_nomb,
	...
	order by rpc_numlin;
grant select  on v_resprcli to public;
-- insert into linresprcli select 2,lci_nume,pro_codi,prp_ano,prp_seri,prp_part,prp_indi,1,lci_peso,'20180308' from coninvlin where cci_codi=6634	
--
-- Datos Trasnporte albaran
...
drop view v_cliprv;
drop view v_cliente;
alter table clientes alter cli_nomco type varchar(120);
alter table cliencamb alter cli_nomco type varchar(120);
CREATE OR REPLACE VIEW v_cliente AS 
 SELECT clientes.cli_codi, clientes.cli_nomb, clientes.cli_nomco, 
    clientes.cli_direc, clientes.cli_pobl, clientes.cli_codpo, 
    clientes.cli_telef, clientes.cli_fax, clientes.cli_nif, clientes.cli_percon, 
...
--- Cambiado pais matadero y sala despiece a iniciales del pais
